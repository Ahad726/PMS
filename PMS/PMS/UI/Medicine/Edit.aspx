<%@ Page Title="Edit Medicine" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="PMS.UI.Medicine.Edit" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main class="main-section">
        <div class="card">
            <div class="card-header">
                <asp:Label ID="lblTitle" runat="server" Text="Edit Medicine"></asp:Label>
            </div>
            <div class="card-body">
                <div>
                    ...
                    <table class="auto-style1">
                        ...
                        <tr>
                            ...
                            <td class="auto-style5">&nbsp;<asp:TextBox runat="server" ID="MedicineIdTxtBox" Visible="False"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="auto-style5">&nbsp;</td>
                            <td class="auto-style5">
                                <asp:Button ID="MedUpdateButton" runat="server" CssClass="btn" OnClick="MedUpdateButton_Click" Text="Save" Width="102px" />

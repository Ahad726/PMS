<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="PMS.UI.Invoice.Create" %>
    ...
    <form id="InvoiceForm" runat="server">
            ...
            <table border="1" style="border-collapse: collapse">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td>
                            <span onclick="AddNewRow()" style="color: green; font-size: x-large; font-weight: bolder; cursor: pointer">+</span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4"></td>
        ...
        <table style="margin-top: 10px;">
            <tr>
                ...
                <td>
                    <asp:Button ID="ClearButton" runat="server" Text="Clear" OnClick="ClearButton_Click"></asp:Button>
                </td>
            </tr>
        </table>
    </form>
